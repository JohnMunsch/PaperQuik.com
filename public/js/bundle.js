(() => {
  ...
  var n2 = class extends HTMLElement {
    ...
    static createProperty(t4, i5 = o2) {
    ...
    addController(t4) {
      var i5, s5;
      ((i5 = this._$Em) !== null && i5 !== void 0 ? i5 : this._$Em = []).push(t4), this.renderRoot !== void 0 && this.isConnected && ((s5 = t4.hostConnected) === null || s5 === void 0 || s5.call(t4));
    }
    removeController(t4) {
      var i5;
      (i5 = this._$Em) === null || i5 === void 0 || i5.splice(this._$Em.indexOf(t4) >>> 0, 1);
    }
    _$Ep() {
    ...
    _$Eg(t4, i5, s5 = o2) {
      var e5, h3;
      const n5 = this.constructor._$Eh(t4, s5);
      if (n5 !== void 0 && s5.reflect === true) {
        const o5 = ((h3 = (e5 = s5.converter) === null || e5 === void 0 ? void 0 : e5.toAttribute) !== null && h3 !== void 0 ? h3 : r2.toAttribute)(i5, s5.type);
        this._$Ei = t4, o5 == null ? this.removeAttribute(n5) : this.setAttribute(n5, o5), this._$Ei = null;
      }
    }
    _$AK(t4, i5) {
      var s5, e5, h3;
      const o5 = this.constructor, n5 = o5._$Eu.get(t4);
      if (n5 !== void 0 && this._$Ei !== n5) {
        const t5 = o5.getPropertyOptions(n5), l3 = t5.converter, a2 = (h3 = (e5 = (s5 = l3) === null || s5 === void 0 ? void 0 : s5.fromAttribute) !== null && e5 !== void 0 ? e5 : typeof l3 == "function" ? l3 : null) !== null && h3 !== void 0 ? h3 : r2.fromAttribute;
        this._$Ei = n5, this[n5] = a2(i5, t5.type), this._$Ei = null;
      }
    }
    requestUpdate(t4, i5, s5) {
      let e5 = true;
      t4 !== void 0 && (((s5 = s5 || this.constructor.getPropertyOptions(t4)).hasChanged || h)(this[t4], i5) ? (this._$AL.has(t4) || this._$AL.set(t4, i5), s5.reflect === true && this._$Ei !== t4 && (this._$ES === void 0 && (this._$ES = new Map()), this._$ES.set(t4, s5))) : e5 = false), !this.isUpdatePending && e5 && (this._$Ev = this._$EC());
    }
    async _$EC() {
    ...
    performUpdate() {
      ...
      const s5 = this._$AL;
      try {
        i5 = this.shouldUpdate(s5), i5 ? (this.willUpdate(s5), (t4 = this._$Em) === null || t4 === void 0 || t4.forEach((t5) => {
          var i6;
    ...
    _$AE(t4) {
      var i5;
      (i5 = this._$Em) === null || i5 === void 0 || i5.forEach((t5) => {
        var i6;
    ...
    update(t4) {
      this._$ES !== void 0 && (this._$ES.forEach((t5, i5) => this._$Eg(i5, this[i5], t5)), this._$ES = void 0), this._$EU();
    }
    updated(t4) {
    }
    firstUpdated(t4) {
  ...
  var w = (t4, i5, s5) => {
    ...
    if (l3 === void 0) {
      ...
      n5._$litPart$ = l3 = new N(i5.insertBefore(h2(), t5), t5, void 0, s5 != null ? s5 : {});
    }
    return l3._$AI(t4), l3;
  };
  var A = l.createTreeWalker(l, 129, null, false);
  var C = (t4, i5) => {
    const o5 = t4.length - 1, l3 = [];
    ...
    for (let i6 = 0; i6 < o5; i6++) {
      ...
      r4 += d2 === c ? s5 + n3 : $2 >= 0 ? (l3.push(o6), s5.slice(0, $2) + "$lit$" + s5.slice($2) + e3 + y2) : s5 + e3 + ($2 === -2 ? (l3.push(void 0), i6) : y2);
    }
  ...
  var P = class {
    constructor({ strings: t4, _$litType$: s5 }, n5) {
      ...
      this.parts = [];
      let r4 = 0, d2 = 0;
      const u2 = t4.length - 1, c2 = this.parts, [v2, a2] = C(t4, s5);
      ...
      for (; (l3 = A.nextNode()) !== null && c2.length < u2; ) {
        if (l3.nodeType === 1) {
          if (l3.hasAttributes()) {
            const t5 = [];
            for (const i5 of l3.getAttributeNames())
              if (i5.endsWith("$lit$") || i5.startsWith(e3)) {
                const s6 = a2[d2++];
                if (t5.push(i5), s6 !== void 0) {
                  const t6 = l3.getAttribute(s6.toLowerCase() + "$lit$").split(e3), i6 = /([.?@])?(.*)/.exec(s6);
                  c2.push({ type: 1, index: r4, name: i6[2], strings: t6, ctor: i6[1] === "." ? M : i6[1] === "?" ? k : i6[1] === "@" ? H : S2 });
                } else
                  c2.push({ type: 6, index: r4 });
              }
            for (const i5 of t5)
              l3.removeAttribute(i5);
          }
          if (g.test(l3.tagName)) {
            const t5 = l3.textContent.split(e3), s6 = t5.length - 1;
            if (s6 > 0) {
              l3.textContent = i2 ? i2.emptyScript : "";
              for (let i5 = 0; i5 < s6; i5++)
                l3.append(t5[i5], h2()), A.nextNode(), c2.push({ type: 2, index: ++r4 });
              l3.append(t5[s6], h2());
            }
          }
          ...
          if (l3.data === o3)
            ...
            let t5 = -1;
            for (; (t5 = l3.data.indexOf(e3, t5 + 1)) !== -1; )
  ...
  function V(t4, i5, s5 = t4, e5) {
    ...
    return (d2 == null ? void 0 : d2.constructor) !== u2 && ((n5 = d2 == null ? void 0 : d2._$AO) === null || n5 === void 0 || n5.call(d2, false), u2 === void 0 ? d2 = void 0 : (d2 = new u2(t4), d2._$AT(t4, s5, e5)), e5 !== void 0 ? ((l3 = (h3 = s5)._$Cl) !== null && l3 !== void 0 ? l3 : h3._$Cl = [])[e5] = d2 : s5._$Cu = d2), d2 !== void 0 && (i5 = V(t4, d2._$AS(t4, i5.values), d2, e5)), i5;
  }
  var E = class {
    constructor(t4, i5) {
    ...
    p(t4) {
      var i5;
      const { el: { content: s5 }, parts: e5 } = this._$AD, o5 = ((i5 = t4 == null ? void 0 : t4.creationScope) !== null && i5 !== void 0 ? i5 : l).importNode(s5, true);
      A.currentNode = o5;
      let n5 = A.nextNode(), h3 = 0, r4 = 0, d2 = e5[0];
      for (; d2 !== void 0; ) {
        if (h3 === d2.index) {
          let i6;
          d2.type === 2 ? i6 = new N(n5, n5.nextSibling, this, t4) : d2.type === 1 ? i6 = new d2.ctor(n5, d2.name, d2.strings, this, t4) : d2.type === 6 && (i6 = new I(n5, this, t4)), this.v.push(i6), d2 = e5[++r4];
        }
  ...
  var N = class {
    constructor(t4, i5, s5, e5) {
      var o5;
      this.type = 2, this._$AH = T, this._$AN = void 0, this._$AA = t4, this._$AB = i5, this._$AM = s5, this.options = e5, this._$Cg = (o5 = e5 == null ? void 0 : e5.isConnected) === null || o5 === void 0 || o5;
    }
    get _$AU() {
      var t4, i5;
    ...
    _$AI(t4, i5 = this) {
      t4 = V(this, t4, i5), r3(t4) ? t4 === T || t4 == null || t4 === "" ? (this._$AH !== T && this._$AR(), this._$AH = T) : t4 !== this._$AH && t4 !== b && this.$(t4) : t4._$litType$ !== void 0 ? this.T(t4) : t4.nodeType !== void 0 ? this.S(t4) : u(t4) ? this.M(t4) : this.$(t4);
    }
    A(t4, i5 = this._$AB) {
    ...
    T(t4) {
      var i5;
      const { values: s5, _$litType$: e5 } = t4, o5 = typeof e5 == "number" ? this._$AC(t4) : (e5.el === void 0 && (e5.el = P.createElement(e5.h, this.options)), e5);
      if (((i5 = this._$AH) === null || i5 === void 0 ? void 0 : i5._$AD) === o5)
        this._$AH.m(s5);
      else {
        const t5 = new E(o5, this), i6 = t5.p(this.options);
    ...
    M(t4) {
      ...
      let s5, e5 = 0;
      for (const o5 of t4)
        e5 === i5.length ? i5.push(s5 = new N(this.A(h2()), this.A(h2()), this, this.options)) : s5 = i5[e5], s5._$AI(o5), e5++;
  ...
  var S2 = class {
    constructor(t4, i5, s5, e5, o5) {
      this.type = 1, this._$AH = T, this._$AN = void 0, this.element = t4, this.name = i5, this._$AM = e5, this.options = o5, s5.length > 2 || s5[0] !== "" || s5[1] !== "" ? (this._$AH = Array(s5.length - 1).fill(new String()), this.strings = s5) : this._$AH = T;
    }
    get tagName() {
    ...
    _$AI(t4, i5 = this, s5, e5) {
      ...
      let n5 = false;
      if (o5 === void 0)
        t4 = V(this, t4, i5, 0), n5 = !r3(t4) || t4 !== this._$AH && t4 !== b, n5 && (this._$AH = t4);
      else {
        const e6 = t4;
        let l3, h3;
        for (t4 = o5[0], l3 = 0; l3 < o5.length - 1; l3++)
          h3 = V(this, e6[s5 + l3], i5, l3), h3 === b && (h3 = this._$AH[l3]), n5 || (n5 = !r3(h3) || h3 !== this._$AH[l3]), h3 === T ? t4 = T : t4 !== T && (t4 += (h3 != null ? h3 : "") + o5[l3 + 1]), this._$AH[l3] = h3;
      }
      n5 && !e5 && this.k(t4);
    }
    k(t4) {
  ...
  var H = class extends S2 {
    ...
    _$AI(t4, i5 = this) {
      ...
      if ((t4 = (s5 = V(this, t4, i5, 0)) !== null && s5 !== void 0 ? s5 : T) === b)
        return;
      const e5 = this._$AH, o5 = t4 === T && e5 !== T || t4.capture !== e5.capture || t4.once !== e5.once || t4.passive !== e5.passive, n5 = t4 !== T && (e5 === T || o5);
  ...
  var PaperQuikAdblock = class extends s4 {
    ...
    render() {
      return p`<div class="panel panel-default">
  ...
  var AboutPage = class extends s4 {
    ...
    render() {
      return p`<pq-menu active="about"></pq-menu>
      <div class="container">
  ...
  var PaperQuikJumbotron = class extends s4 {
    ...
    render() {
      ...
      return p`<div class="panel jumbotron">
  ...
  var i4 = e4(class extends i3 {
    ...
    update(e5, [r4]) {
      ...
      this.ut.forEach((t4) => {
        r4[t4] == null && (this.ut.delete(t4), t4.includes("-") ? s5.removeProperty(t4) : s5[t4] = "");
      });
      for (const t4 in r4) {
        const e6 = r4[t4];
        e6 != null && (this.ut.add(t4), t4.includes("-") ? s5.setProperty(t4, e6) : s5[t4] = e6);
      }
      return b;
    }
  });
  ...
  var PaperQuikStepOne = class extends s4 {
    ...
    render() {
      return p`<div class="panel panel-default size-section">
      <div class="panel-heading">
        <h2>1: Pick a paper size</h2>
      </div>
      <div class="panel-body">
        ${paperSizes.map((paperSize) => {
        return p`<a href="/paper/${paperSize.id}">
            <div
  ...
  var PaperQuikStepTwo = class extends s4 {
    ...
    render() {
      return p` <div class="panel panel-default layout-section">
      <div class="panel-heading">
        <h2>
          2: Pick a layout
      ...
      <div class="panel-body">
        ${this.size ? p` <div class="layouts-wrapper">
              ${paperLayouts.map((paperLayout) => {
        return p`<a href="/paper/${this.size}/${paperLayout.id}">
                  <div
  ...
  var PaperQuikStepThree = class extends s4 {
    ...
    render() {
      return p`<div class="panel panel-default print-section">
        <div class="panel-heading">
          <h2>3: Print your paper</h2>
        </div>
        <div class="panel-body">
          ${this.size && this.layout ? p`<div class="row">
  ...
  var PaperQuikMenu = class extends s4 {
    ...
    render() {
      return p`<nav class="navbar navbar-expand-lg navbar-dark">
  ...
  var PaperQuikApp = class extends s4 {
    ...
    constructor() {
      ...
      (0, import_page.default)("/about", () => {
        this.renderer = () => p`<about-page></about-page>`;
        this.requestUpdate();
      });
      (0, import_page.default)("/paper/:size?/:layout?", (ctx) => {
        this.renderer = () => p`<paper-page
